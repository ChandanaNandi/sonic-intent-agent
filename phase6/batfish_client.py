...
# Suppress urllib3 connection retry warnings. When Batfish is
# unavailable, urllib3 retries up to 5 times with backoff and logs
# a WARNING for each attempt. Our own BatfishClientError already
# surfaces the unavailability through STATUS_UNAVAILABLE, so the
# urllib3 warnings are noise. We keep ERROR-level urllib3 messages.
